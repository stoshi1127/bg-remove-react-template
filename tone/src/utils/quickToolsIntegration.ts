...
export const QUICKTOOLS_SERVICES: QuickToolsService[] = [
  {
    ...
    name: 'BG Remove',
    description: '背景除去ツール',
    url: 'https://quicktools.app/bg-remove',
    icon: '🖼️',
    category: 'image',
    isActive: true,
  },
  ...
  },
  {
    ...
    name: 'Compress',
    description: '画像圧縮ツール',
    url: 'https://quicktools.app/compress',
    icon: '📦',
    category: 'utility',
    isActive: true,
  },
...
export const QUICKTOOLS_BRAND = {
  ...
  support: {
    help: 'https://quicktools.app/help',
    contact: 'https://quicktools.app/contact',
    privacy: 'https://quicktools.app/privacy',
    terms: 'https://quicktools.app/terms',
  },
} as const;
