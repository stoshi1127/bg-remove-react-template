...
const TrimPage = () => {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-lg max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className="flex items-start p-4 sm:p-6 bg-emerald-50 rounded-2xl">
                <div className="bg-emerald-100 p-3 rounded-xl mr-4 sm:mr-6 mt-1">
                  <svg className="w-6 sm:w-8 h-6 sm:h-8 text-emerald-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"></path>
                  </svg>
                </div>
                <div>
                  <h4 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-slate-800">比率プリセット・カスタム比率</h4>
                  <p className="text-sm sm:text-base text-slate-700 leading-relaxed">SNSアイコンやXヘッダー、Instagram投稿など用途に合わせた比率プリセットや、自由なカスタム比率でトリミングできます。</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* 背景透過機能への誘導セクション */}
      <section className="py-16 sm:py-20 bg-gradient-to-r from-emerald-600 to-green-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href="/">
            <button className="bg-white text-emerald-600 font-semibold py-3 sm:py-4 px-6 sm:px-8 rounded-xl hover:bg-emerald-50 transition duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 text-base sm:text-lg">
              イージーカットを使ってみる
            </button>
          </Link>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-4 sm:space-y-6 max-w-4xl mx-auto">
              <div className="border-l-4 border-emerald-500 pl-4 sm:pl-6 py-3 sm:py-4 bg-emerald-50 rounded-r-lg">
                <h4 className="text-base sm:text-lg font-semibold mb-2 text-slate-800">無料で画像トリミングできますか？</h4>
                <p className="text-sm sm:text-base text-slate-700">はい、イージートリミングは完全無料で画像トリミング処理ができます。登録も不要で、すぐにご利用いただけます。</p>
              </div>
              <div className="border-l-4 border-green-500 pl-4 sm:pl-6 py-3 sm:py-4 bg-green-50 rounded-r-lg">
                <h4 className="text-base sm:text-lg font-semibold mb-2 text-slate-800">iPhone（HEIC形式）の画像もトリミングできますか？</h4>
                <p className="text-sm sm:text-base text-slate-700">はい、iPhoneで撮影したHEIC/HEIF形式の画像も自動的にJPEG/PNG形式に変換してトリミングします。事前変換は不要です。</p>
              </div>
              <div className="border-l-4 border-blue-500 pl-4 sm:pl-6 py-3 sm:py-4 bg-blue-50 rounded-r-lg">
                <h4 className="text-base sm:text-lg font-semibold mb-2 text-slate-800">SNS用の比率でトリミングできますか？</h4>
                <p className="text-sm sm:text-base text-slate-700">はい、Instagram投稿（4:5）、Xヘッダー（3:1）、SNSアイコン（1:1）など、SNS用の比率プリセットを多数ご用意しています。</p>
              </div>
              <div className="border-l-4 border-orange-500 pl-4 sm:pl-6 py-3 sm:py-4 bg-orange-50 rounded-r-lg">
                <h4 className="text-base sm:text-lg font-semibold mb-2 text-slate-800">カスタム比率でトリミングできますか？</h4>
                <p className="text-sm sm:text-base text-slate-700">はい、カスタム比率設定で自由な縦横比でトリミングできます。用途に合わせて柔軟に調整可能です。</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 max-w-6xl mx-auto">
            <div className="text-center">
              <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm mb-4 hover:shadow-md transition-shadow">
                <h4 className="text-base sm:text-lg font-semibold mb-2 text-slate-800">SNS・ソーシャルメディア</h4>
                <p className="text-xs sm:text-sm text-slate-600">Instagram投稿、Xヘッダー、プロフィール画像、ストーリー用画像作成</p>
              </div>
            </div>
            <div className="text-center">
              <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm mb-4 hover:shadow-md transition-shadow">
                <h4 className="text-base sm:text-lg font-semibold mb-2 text-slate-800">ビジネス・ECサイト</h4>
                <p className="text-xs sm:text-sm text-slate-600">商品画像の統一、メルカリ出品画像、バナー制作、プレゼン資料</p>
              </div>
            </div>
            <div className="text-center">
              <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm mb-4 hover:shadow-md transition-shadow">
                <h4 className="text-base sm:text-lg font-semibold mb-2 text-slate-800">デザイン・クリエイティブ</h4>
                <p className="text-xs sm:text-sm text-slate-600">ロゴ作成、アイコンデザイン、Webサイト用画像、印刷物制作</p>
              </div>
            </div>
          </div>
        </div>
