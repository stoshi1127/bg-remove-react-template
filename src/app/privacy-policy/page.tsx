...
export default function PrivacyPolicyPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ul className="list-disc list-inside ml-4">
        <li>
          当サイトが利用目的の達成に必要な範囲内において個人情報の取扱いの全部または一部を委託する場合（上記2.(6)のGoogle社への情報送信、及び上記3.のReplicate社への画像データ送信を含みます）
        </li>
      ...
      <p className="mt-4">
        ...
        当サイトでは、上記(a)および(b)に記載の通り、ユーザーに関する情報を以下の外部事業者に送信しています。
      </p>
      <ul className="list-disc list-inside ml-4">
        <li>送信先事業者名：Google LLC</li>
        <li>送信される情報の内容：上記(a)および(b)に記載の通り</li>
        <li>送信される情報の利用目的：上記(a)および(b)に記載の通り</li>
      </ul>
