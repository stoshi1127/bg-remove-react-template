...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* ヒーローセクション */}
      <section className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex flex-col items-center justify-center px-4 py-12 relative overflow-hidden">
        {/* 背景装飾 */}
          ...
          <div className="bg-white rounded-3xl p-12 shadow-lg max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex items-start p-6 bg-blue-50 rounded-2xl">
                <div className="bg-blue-100 p-3 rounded-xl mr-6 mt-1">
                  <svg className="w-8 h-8 text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"></path>
                  </svg>
                </div>
                <div>
                  <h4 className="text-xl font-bold mb-3 text-slate-800">複数画像の一括処理</h4>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-700">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href="/trim">
            <button className="bg-white text-blue-600 font-semibold py-4 px-8 rounded-xl hover:bg-blue-50 transition duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 text-lg">
              イージートリミングを使ってみる
            </button>
          </Link>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-6 max-w-4xl mx-auto">
              <div className="border-l-4 border-blue-500 pl-6 py-4 bg-blue-50 rounded-r-lg">
                <h4 className="text-lg font-semibold mb-2 text-slate-800">無料で背景透過できますか？</h4>
                <p className="text-slate-700">はい、イージーカットは完全無料で背景透過・背景除去処理ができます。登録も不要で、すぐにご利用いただけます。</p>
              </div>
              <div className="border-l-4 border-green-500 pl-6 py-4 bg-green-50 rounded-r-lg">
                <h4 className="text-lg font-semibold mb-2 text-slate-800">iPhone（HEIC形式）の画像も処理できますか？</h4>
                <p className="text-slate-700">はい、iPhoneで撮影したHEIC/HEIF形式の画像も自動的にJPEG/PNG形式に変換して処理します。事前変換は不要です。</p>
              </div>
              <div className="border-l-4 border-purple-500 pl-6 py-4 bg-purple-50 rounded-r-lg">
                <h4 className="text-lg font-semibold mb-2 text-slate-800">複数の画像を一度に処理できますか？</h4>
                <p className="text-slate-700">はい、複数の画像を一括でアップロードして同時に背景透過処理ができます。効率的な作業が可能です。</p>
              </div>
              <div className="border-l-4 border-orange-500 pl-6 py-4 bg-orange-50 rounded-r-lg">
                <h4 className="text-lg font-semibold mb-2 text-slate-800">処理した画像のセキュリティは大丈夫ですか？</h4>
                <p className="text-slate-700">処理済み画像は60分以内に自動削除され、第三者がアクセスすることはありません。安全にご利用いただけます。</p>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="text-center">
              <div className="bg-white p-6 rounded-xl shadow-sm mb-4 hover:shadow-md transition-shadow">
                <h4 className="text-lg font-semibold mb-2 text-slate-800">ビジネス・ECサイト</h4>
                <p className="text-slate-600 text-sm">商品画像の背景除去、カタログ制作、プレゼン資料作成</p>
              </div>
            </div>
            <div className="text-center">
              <div className="bg-white p-6 rounded-xl shadow-sm mb-4 hover:shadow-md transition-shadow">
                <h4 className="text-lg font-semibold mb-2 text-slate-800">SNS・個人利用</h4>
                <p className="text-slate-600 text-sm">Instagram投稿、LINE着せ替え、プロフィール画像作成</p>
              </div>
            </div>
            <div className="text-center">
              <div className="bg-white p-6 rounded-xl shadow-sm mb-4 hover:shadow-md transition-shadow">
                <h4 className="text-lg font-semibold mb-2 text-slate-800">デザイン・クリエイティブ</h4>
                <p className="text-slate-600 text-sm">グラフィックデザイン、ポスター制作、Webデザイン</p>
              </div>
            </div>
          </div>
        </div>
