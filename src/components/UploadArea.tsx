...
const UploadArea: React.FC<UploadAreaProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-4 sm:gap-5 md:gap-6 z-10">
        <div className={`w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-3xl flex items-center justify-center transition-all duration-300
        ...
        <button
          className="mt-2 sm:mt-4 bg-primary text-white px-6 sm:px-8 md:px-10 py-3 sm:py-3.5 md:py-4 rounded-full text-sm sm:text-base md:text-lg font-black hover:bg-blue-600 transition-all shadow-lg shadow-primary/20 pointer-events-none"
          tabIndex={-1}
        >
          ファイルを選択
        </button>
